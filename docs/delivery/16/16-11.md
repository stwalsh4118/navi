...
- [ ] Branch display test passes
- [ ] Dirty indicator test passes
- [ ] Ahead/behind test passes
- [ ] PR detection test passes
- [ ] Git detail view test passes
- [ ] Diff preview test passes
- [ ] PR link test passes
- [ ] Caching test passes
- [ ] Non-git handling test passes
- [ ] All tests pass
