...
- Implemented PM view state fields, toggle handling, and layout skeleton in `model.go`, `view.go`, `styles.go`, and new `pmview.go`.
- Verified placeholder rendering for briefing/projects/events and PM-specific header/footer hints.
- Verification commands:
  - `go build ./...`
  - `go test ./internal/tui/... -run TestPMViewToggleAndFooter|TestPMViewHeaderAndPlaceholder`
  - `go test ./...`
