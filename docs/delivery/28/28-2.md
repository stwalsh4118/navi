...
- `internal/task/config.go` (created) - FindProjectConfig, LoadGlobalConfig, MergeConfig, NormalizeStatus
- `internal/task/discover.go` (created) - DiscoverProjects
- `internal/task/config_test.go` (created) - 16 tests covering all functions
