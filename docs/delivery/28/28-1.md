...
| 2026-02-06 19:37:27 | Status Change | Proposed | InProgress | Started implementation | AI_Agent |
| 2026-02-06 19:38:32 | Status Change | InProgress | Review | Implementation complete, ready for review | AI_Agent |
...
- `internal/task/types.go` - Task, TaskGroup, ProviderResult, ProjectConfig, GlobalConfig structs with JSON/YAML tags
- `internal/task/types_test.go` - Unit tests for JSON parsing (grouped, flat, optional fields, malformed)
