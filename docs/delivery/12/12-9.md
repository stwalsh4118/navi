...
- [ ] Aggregate calculation function implemented
- [ ] Aggregate display visible (header or dashboard)
- [ ] Tokens sum correctly
- [ ] Time sums correctly
- [ ] Tool counts merge correctly
- [ ] Handles sessions without metrics
