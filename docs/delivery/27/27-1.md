...
- `internal/remote/git.go` (created) - FetchGitInfo, buildGitCommand, parseGitOutput, parseAheadBehind
- `internal/remote/git_test.go` (created) - Unit tests for git output parsing
