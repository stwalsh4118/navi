...
| 2026-02-12 09:27:53 | Status Change | Proposed | InProgress | Started implementation | AI_Agent |
| 2026-02-12 09:29:31 | Status Change | InProgress | Review | Implementation complete, ready for review | AI_Agent |
...
- `internal/git/pr.go` (new) — PRDetail, Reviewer, Check, CheckSummary structs, constants, helper methods, PRComment type
- `internal/git/git.go` — Added PRDetail pointer field to Info struct
- `internal/git/pr_test.go` (new) — Unit tests for all PR data model types and helpers
