...
| 58 | User | As a user, I want to browse and switch sound packs from within the TUI so that I can customize audio without editing config files | Agreed | [View Details](./58/prd.md) |
