...
| 57 | User | As a user, I want to see per-session RAM usage in the sidebar so that I can spot memory leaks at a glance without leaving the TUI | Agreed | [View Details](./57/prd.md) |
