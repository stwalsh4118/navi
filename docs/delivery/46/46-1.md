...
Define all core data structures and constants for the PM engine in a new `internal/pm/` package. These types are the foundation for project discovery, snapshot capture, diffing, and event emission. No business logic — purely type definitions.
...
- `test/unit/pm/types_test.go` (new)
