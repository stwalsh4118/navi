...
| 2026-02-15 19:27:19 | Status Change | Proposed | InProgress | Started implementation | AI_Agent |
| 2026-02-15 19:30:13 | Status Change | InProgress | Review | Implementation complete, internal AI review passed | AI_Agent |
...
3. Update `docs/api-specs/session/session-api.md` — add `ExternalAgent` type and `Agents` field to `Info`
4. Write unit tests
...
- Confirmed JSON behaviors via unit tests: round-trip with single/multiple agents, omit on nil/empty map, backward-compatible unmarshal without `agents`
